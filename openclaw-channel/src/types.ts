...
export type PlatformInboundMessage =
  ...
  | { type: "pong" }
  | { type: "session_created"; session_id: string; expert_id: string; topic: string }
  | { type: "new_session"; session_id: string; topic: string; requester_agent_id: string; message: string | null }
...
export type PlatformOutboundMessage =
  | { type: "ping" }
  | { type: "create_session"; expert_id: string; topic: string; message: string }
